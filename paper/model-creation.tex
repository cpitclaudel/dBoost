...
\begin{figure}%
  ...
  \cramped{1}{../graphics/models-plots.pdf}{Gaussian}{gaussian}\hspace*{.01\linewidth}
  \cramped{2}{../graphics/models-plots.pdf}{Mixture}{mixture}\hspace*{.01\linewidth}
  \cramped{3}{../graphics/models-plots.pdf}{Histogram}{histogram}
