...
\begin{figure}%
  ...
  \cramped{1}{../graphics/plots/models-plots.pdf}{Gaussian}{gaussian}\hspace*{.01\linewidth}
  \cramped{2}{../graphics/plots/models-plots.pdf}{Mixture}{mixture}\hspace*{.01\linewidth}
  \cramped{3}{../graphics/plots/models-plots.pdf}{Histogram}{histogram}
