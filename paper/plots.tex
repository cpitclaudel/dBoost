...
\begin{figure*}
  ...
  \cramped{2}{GMM, $n = 1$, $\theta=0.075$}{gmm1t075}\hspace{\fill}
  \cramped{3}{GMM, $n = 2$, $\theta=0.075$}{gmm2t075}\hspace{\fill}
  \cramped{4}{Local Outlier Factor, $k = 2$}{lofk2}\hspace{\fill}
