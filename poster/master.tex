...
\begin{frame}[fragile]{}
  ...
  \begin{columns}[T,totalwidth=\textwidth]
    ...
    \begin{column}{\doublecolwidth}
      ...
      \begin{columns}[t,totalwidth=\textwidth]
        \begin{column}{\colwidth}
          \input{analysis-and-modeling} \vspace{\blocksep}
        \end{column}

        \begin{column}{\colwidth}
          \input{evaluation} \vspace{\blocksep}
          \input{future-work} \vspace{\blocksep}
        \end{column}      
      \end{columns}
    \end{column}      
  \end{columns}
